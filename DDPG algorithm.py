...
class InventoryEnvironment(gym.Env):
    def __init__(self, initial_bloem_units, initial_ware_units, initial_prod_units, initial_durb_units,
        ...
        self.bloem_ware_backlog_sum = 0
        self.durb_prod_backlog_sum = 0
        self.durb_ware_backlog_sum = 0
        self.EL_prod_backlog_sum = 0
        self.EL_ware_backlog_sum = 0
        self.CT_prod_backlog_sum = 0
        self.CT_ware_backlog_sum = 0
        self.pret_prod_backlog_sum = 0
        self.pret_ware_backlog_sum = 0
        self.prod_ware_backlog_sum = 0
    ...
    def reset(self, **kwargs):
        ...
        ware_forecast = self.total_pred_jhb[self.day-4:self.day + 4]
    ...
    def step(self, action):
        ...
        self.bloem_ware_backlog_sum = sum(self.bloem_warehouse_order_backlog)
        self.durb_prod_backlog_sum = sum(self.durb_production_order_backlog)
        self.durb_ware_backlog_sum = sum(self.durb_warehouse_order_backlog)
        self.EL_prod_backlog_sum = sum(self.EL_production_order_backlog)
        self.EL_ware_backlog_sum = sum(self.EL_warehouse_order_backlog)
        self.CT_prod_backlog_sum = sum(self.CT_production_order_backlog)
        self.CT_ware_backlog_sum = sum(self.CT_warehouse_order_backlog)
        self.pret_prod_backlog_sum = sum(self.pret_production_order_backlog)
        self.pret_ware_backlog_sum = sum(self.pret_warehouse_order_backlog)
        self.prod_ware_backlog_sum = sum(self.prod_ware_order_backlog)
...
if __name__ == "__main__":
    ...
    with summary_writer.as_default():
        ...
        trucks_prod_pret_vector = []
        trucks_ware_pret_vector = []
        ware_units_available_vector = []
        prod_units_available_vector = []
        trucks_prod_ware_vector = []
        units_produced_production_vector = []
        ware_fill_rate_vector = []
        ...
        for day in range(341):
            ...
            ware_units_available_vector.append(env.ware_units_sum)
            tf.summary.scalar('Ware/Ware fill rate', env.fill_rate_ware, step=day)
            ware_fill_rate_vector.append(env.fill_rate_ware)
            ...
            trucks_prod_ware_vector.append(env.no_of_trucks_prod_ware)
            ...
            trucks_prod_pret_vector.append(env.no_of_trucks_prod_pret)
            tf.summary.scalar('Trucks/Number of trucks in operation ware to pret', env.no_of_trucks_ware_pret, step=day)
            trucks_ware_pret_vector.append(env.no_of_trucks_ware_pret)
        ...
        print(f"Test obsolete inventory: {env.obsolete_inventory}")
        print(f"Test units unsatisfied: {env.units_unsatisfied}")
        ...
        y6 = durb_units_available_vector
        plt.figure()
        plt.plot(x, y6)
        plt.xlabel('Day')
        plt.ylabel('Butter units')
        ...
        y9 = trucks_prod_pret_vector
        plt.figure()
        plt.scatter(x, y9)
        plt.xlabel('Day')
        plt.ylabel('Number of trucks')
        plt.title('Number of trucks between Production and Pretoria')
        plt.show()

        y10 = trucks_ware_pret_vector
        plt.figure()
        plt.scatter(x, y10)
        plt.xlabel('Day')
        plt.ylabel('Number of trucks')
        plt.title('Number of trucks between Warehouse and Pretoria')
        plt.show()

        y11 = ware_units_available_vector
        plt.figure()
        plt.plot(x, y11)
        plt.xlabel('Day')
        plt.ylabel('Butter units')
        plt.title('Warehouse/Units available')
        plt.show()

        y12 = prod_units_available_vector
        plt.figure()
        plt.plot(x, y12)
        plt.xlabel('Day')
        plt.ylabel('Butter units')
        ...
        y13 = trucks_prod_ware_vector
        plt.figure()
        plt.scatter(x, y13)
        plt.xlabel('Day')
        plt.ylabel('Number of trucks')
        plt.title('Number of trucks between Production and Warehouse')
        plt.show()

        y14 = units_produced_production_vector
        plt.figure()
        plt.scatter(x, y14)
        plt.xlabel('Day')
        plt.ylabel('Butter units')
        ...
        y15 = ware_fill_rate_vector
        plt.figure()
        plt.plot(x, y15)
        plt.xlabel('Day')
        plt.ylabel('Order fulfilment rate (%)')
        plt.title('Warehouse/Order fulfilment rate')
        plt.show()
