...
class InventoryEnvironment(gym.Env):
    ...
    def step(self, action):
        ...
        '''if self.current_revenue - self.current_cost > 150000:
            reward += 90
        elif self.current_revenue - self.current_cost > 100000:
            reward += 50
        elif self.current_revenue - self.current_cost > 50000:
            reward += 30
        elif self.current_revenue - self.current_cost > 0:
            reward += 10
        else:
            reward -= 50'''
        ...
        #reward -= self.bloem_units/10000
        #reward -= self.ware_units/10000
        #reward -= self.prod_units/10000
